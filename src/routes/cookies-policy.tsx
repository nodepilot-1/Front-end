...
function CookiesPolicy() {
  return (
    <div className="min-h-screen bg-background text-foreground py-24 px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <Link to="/" className="inline-flex items-center gap-2 text-sm text-secondary hover:text-white transition-colors mb-12">
          <ChevronLeft className="w-4 h-4" /> Back to Home
        </Link>
        
        <div className="terms-content prose-invert max-w-none text-muted-foreground leading-relaxed
          [&>h1]:text-4xl [&>h1]:md:text-5xl [&>h1]:font-heading [&>h1]:font-bold [&>h1]:text-white [&>h1]:mb-8
          [&>h2]:text-2xl [&>h2]:font-bold [&>h2]:text-white [&>h2]:mt-10 [&>h2]:mb-4
          [&>h3]:text-xl [&>h3]:font-semibold [&>h3]:text-white [&>h3]:mt-8 [&>h3]:mb-3
          [&>h4]:text-lg [&>h4]:font-semibold [&>h4]:text-white [&>h4]:mt-6 [&>h4]:mb-2
          [&>p]:mb-4
          [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-3 [&>ul]:my-6
          [&_strong]:text-white
          [&_a]:text-secondary [&_a]:hover:text-white [&_a]:transition-colors
        ">
          ...
          <ul>
          <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to node-pilot, 1100 Glendon Ave, Los Angeles, CA 90024, USA.</li>
          <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
          <li><strong>Website</strong> refers to node-pilot.com, accessible from <a href="https://node-pilot.com" rel="external nofollow noopener noreferrer" target="_blank">https://node-pilot.com</a>.</li>
          ...
          <ul>
          <li>By email: contact@node-pilot.com</li>
          </ul>
        </div>
      </div>
    </div>
