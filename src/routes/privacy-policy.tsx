    ...
    <div className="min-h-screen bg-background text-foreground py-24 px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        ">
          ...
          <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to node-pilot, 1100 Glendon Ave, Los Angeles, CA 90024, USA.</p>
          </li>
          <li>
          ...
          <li>
          <p><strong>Website</strong> refers to node-pilot.com, accessible from <a href="http://node-pilot.com" rel="external nofollow noopener noreferrer" target="_blank">http://node-pilot.com</a>.</p>
          </li>
          <li>
